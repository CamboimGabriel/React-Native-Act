      ...
      >
        {({
          ...
          <>
            ...
            <View style={styles.box}>
              <Text>
                Selecione o número que melhor descreve o seu comportamento com a
                sua criança. Os números 1 e 2 indicam que o seu comportamento
                está mais próximo do enunciado da esquerda; o número 3 indica
                que está no meio; e os números 4 e 5 indicam que o seu
                comportamento está mais próximo do enunciado da direita
              </Text>
            ...
            <View style={styles.box}>
              <Text>
                Selecione a alternativa que melhor descreva a CRIANÇA. Responda
                a todas as perguntas da melhor maneira possível, mesmo que você
                não tenha certeza absoluta ou se a pergunta lhe parecer
                estranha. Dê suas respostas com base no comportamento atual da
                criança.
              </Text>
